...
# Form implementation generated from reading ui file 'c:\Users\yunus\OneDrive\Desktop\atmproject\deneme\login.ui'
#
...
"border-color: rgb(0, 0, 128);")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Users\\yunus\\OneDrive\\Desktop\\atmproject\\deneme\\../../../gümüst/icons/icns/account.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap("c:\\Users\\yunus\\OneDrive\\Desktop\\atmproject\\deneme\\../../gümüst/icons/icns/account.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("c:\\Users\\yunus\\OneDrive\\Desktop\\atmproject\\deneme\\../../../gümüst/icons/icns/Küçük indir (2) .png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("c:\\Users\\yunus\\OneDrive\\Desktop\\atmproject\\deneme\\../../../gümüst/icons/icns/Küçük images (1) .png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("c:\\Users\\yunus\\OneDrive\\Desktop\\atmproject\\deneme\\../../../gümüst/icons/icns/Küçük indir (4) .png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap("c:\\Users\\yunus\\OneDrive\\Desktop\\atmproject\\deneme\\../../gümüst/icons/icns/Küçük indir (4) .png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        self.exit_button.setGeometry(QtCore.QRect(360, 100, 91, 81))
        self.exit_button.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("c:\\Users\\yunus\\OneDrive\\Desktop\\atmproject\\deneme\\../../../gümüst/icons/icns/exit 2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon4.addPixmap(QtGui.QPixmap("c:\\Users\\yunus\\OneDrive\\Desktop\\atmproject\\deneme\\../../gümüst/icons/icns/exit 2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.exit_button.setIcon(icon4)
        self.exit_button.setIconSize(QtCore.QSize(80, 100))
        ...
        self.clear_button.clicked.connect(self.idnum_edit.clear)
        self.exit_button_2.clicked.connect(loginScreen.close)
        self.clear_button.clicked.connect(self.password_edit.clear)
